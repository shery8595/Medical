            ...
            <Prose className="max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 mb-8">
                    {[
                        ...
                        { id: "S7", title: "MCP (AI tools)", desc: "Local Model Context Protocol server for Cursor, Codex, and sponsor automation — not hosted in production.", color: "cyan", links: [{ label: "Overview", href: "/docs/mcp" }, { label: "Setup", href: "/docs/mcp/setup" }, { label: "Tools", href: "/docs/mcp/tools" }] },
