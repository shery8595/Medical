    ...
    return (
        <motion.div>
            <Prose className="max-w-none">
                ...
                <div className="my-12 p-8 border border-slate-200 rounded-3xl bg-blue-500/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-slate-900 mt-0 mb-2">100% Pass Rate Achieved</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 my-10 not-prose">
                    ...
                    <div className="p-8 rounded-3xl border border-slate-200 bg-white hover:border-blue-500/30 transition-all group overflow-hidden relative">
                        ...
                        <h4 className="font-bold text-slate-900 text-xl mb-3">EligibilityEngine.sol</h4>
                        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                            Validated the mathematical accuracy of homomorphic comparisons against encrypted patient profiles.
                        </p>
                        <ul className="space-y-3 m-0 p-0 text-xs font-medium text-slate-600">
                    ...
                    <div className="p-8 rounded-3xl border border-slate-200 bg-white hover:border-purple-500/30 transition-all group overflow-hidden relative">
                        ...
                        <h4 className="font-bold text-slate-900 text-xl mb-3">StakingManager.sol</h4>
                        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                    ...
                    <div className="p-8 rounded-3xl border border-slate-200 bg-white hover:border-blue-500/30 transition-all group overflow-hidden relative">
                        ...
                        <h4 className="font-bold text-slate-900 text-xl mb-3">ConfidentialETH.sol</h4>
                        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                    ...
                    <div className="p-8 rounded-3xl border border-slate-200 bg-white hover:border-amber-500/30 transition-all group overflow-hidden relative">
                        ...
                        <h4 className="font-bold text-slate-900 text-xl mb-3">Lifecycle & Integration</h4>
                        <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                ...
                <div className="my-8 rounded-2xl overflow-hidden border border-slate-200 bg-slate-950 p-6 font-mono text-sm shadow-inner">
                ...
                <pre className="p-6 bg-slate-100 border border-slate-200 rounded-2xl text-xs md:text-sm font-mono overflow-x-auto text-slate-800">
  ...
  100 passing (186ms)`}
                ...
                <div className="mt-16 pt-8 border-t border-slate-200 flex items-center justify-between">
                    <div>
                        ...
                        <div className="text-slate-900 font-medium">March 10, 2026</div>
                    </div>
