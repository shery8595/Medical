...
export const AUDIT_TRACEABILITY: Array<{ finding: string; tests: string }> = [
    ...
    { finding: "Relayer re-decrypt defense-in-depth (P0.2, optional)", tests: "RDV-01–05, REL-FF-01" },
    { finding: "Patient-decrypt default — relayer ACL isolation", tests: "PDV-01–03" },
