  ...
  return (
    <div className="min-h-screen pb-16 space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 relative">
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-teal-500/10 blur-[100px] rounded-full pointer-events-none" />
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="h-8 w-8 rounded-xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center">
              <UserCheck className="h-4 w-4 text-teal-400" />
            </div>
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-teal-400 font-black">
              ◈ Recruitment Hub
            </p>
          </div>
          ...
          <p className="text-slate-400 max-w-xl text-[15px] leading-relaxed border-l-2 border-teal-500/20 pl-5 py-1">
        ...
        <div className="flex items-center gap-3 shrink-0 pt-2">
          <button className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 text-slate-400 font-mono text-[11px] uppercase tracking-widest font-black transition-all hover:bg-white/10 hover:text-white group">
            <Search className="h-4 w-4 group-hover:text-teal-400 transition-colors" /> Search Candidates
          </button>
        </div>
      </div>
      ...
      <div className="relative">
        {loading ? (
          <div className="py-32 flex flex-col items-center justify-center space-y-6">
            <div className="relative">
              <div className="h-16 w-16 rounded-3xl border-2 border-teal-500/20 animate-spin" />
              ...
              >
                ...
                <div className="flex items-center justify-between px-2">
                  <div className="flex items-center gap-4">
                    <div className="h-10 w-10 rounded-xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-teal-500">
                  ...
                  <div className="space-y-3">
                    {group.matches.map((match, i) => (
                      <motion.div
                        ...
                        className="group relative grid grid-cols-[1.5fr_1fr_1fr_1fr_100px] items-center px-8 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl transition-all duration-500 hover:shadow-2xl hover:shadow-teal-500/5 hover:-translate-y-1 hover:border-teal-500/30 overflow-hidden"
                      >
                        {/* Glow layer */}
                        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
                          <div className="absolute -top-20 -left-20 w-40 h-40 bg-teal-500/5 blur-[50px] rounded-full" />
                        </div>

                        {/* Identity */}
                        <div className="flex items-center gap-4 relative z-10">
                          <div className="h-11 w-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center font-black text-[10px] text-teal-500 shadow-inner group-hover:scale-110 transition-transform duration-500">
                            VP
                          </div>
                          <div className="flex flex-col">
                            <span className="font-mono text-sm font-black text-white group-hover:text-teal-400 transition-colors tracking-tight">
                        ...
                        <div className="flex items-center gap-2 relative z-10">
                          <div className={cn(
                            ...
                            (match.matchScore || 0) === 100 ? "bg-teal-500 shadow-[0_0_8px_rgba(20,184,166,0.6)] animate-pulse" : "bg-indigo-500"
                          )} />
                        ...
                        <div className="relative z-10">
                          <Badge
                            className={cn(
                              ...
                              match.status === "Accepted" ? "bg-teal-500/10 text-teal-400" :
                        ...
                        <div className="text-right relative z-10">
                          {match.status === "Pending" ? (
                            <Button
                              size="sm"
                              className="bg-teal-600 hover:bg-teal-700 shadow-lg shadow-teal-500/20 gap-2 font-black text-[10px] uppercase tracking-widest px-4 h-9 rounded-xl transition-all"
                            ...
                            <button className="p-2 rounded-xl bg-white/5 border border-white/5 text-slate-500 hover:text-teal-400 hover:bg-white/10 transition-all">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none opacity-20">
                <div className="absolute -top-40 -right-40 w-96 h-96 bg-teal-500/30 blur-[100px] rounded-full animate-pulse" />
              ...
              <div className="px-10 pb-8 relative z-10 text-center">
                <div className="mx-auto w-16 h-16 rounded-3xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center mb-6 shadow-2xl">
                ...
                <p className="text-slate-400 font-mono text-xs uppercase tracking-[0.2em] mb-8">
                  Patient ID: <span className="text-teal-400">{selectedMatch.patientId.slice(0, 16)}...</span>
                </p>
                ...
                <div className="space-y-6 text-left">
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full h-40 p-6 rounded-3xl border border-white/10 bg-white/5 text-slate-200 text-sm focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500/30 outline-none transition-all resize-none shadow-inner"
                      value={message}
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    ...
                    <Button
                      className="h-16 rounded-3xl bg-teal-600 hover:bg-teal-700 text-white font-black text-xs uppercase tracking-[0.2em] transition-all shadow-[0_20px_40px_-10px_rgba(20,184,166,0.3)]"
              ...
              <div className="px-10 py-5 bg-white/5 border-t border-white/5 flex items-center justify-between relative z-10">
                <div className="flex items-center gap-2">
                  <div className="h-1.5 w-1.5 rounded-full bg-teal-500 animate-pulse shadow-[0_0_8px_rgba(20,184,166,1)]" />
