            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative z-50 w-full max-w-lg overflow-hidden bg-white dark:bg-slate-950 shadow-2xl rounded-[32px] border border-slate-200 dark:border-slate-800"
                    >
                        {children}
                        <button
                            onClick={() => onOpenChange(false)}
